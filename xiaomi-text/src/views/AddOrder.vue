<template>
  <div class="confirm">
    ...
    <div class="confirm-top">
      <i class="el-icon-s-order" style="color: #ff6700"></i> 确定订单
    </div>
    <div class="confirm-content">
      ...
      <div class="confirm-goods">
        ...
        <div class="goods-list">
          <ul>
            <li
              v-for="(item, index) in $store.state.cartList.filter(
                (item) => item.check
              )"
              :key="index"
            >
        ...
        <div class="money-box">
          <ul>
            ...
            <li class="total">
              ...
              <span class="value">
                <span class="total-price">1799</span> 元</span
              >
            </li>
          </ul>
        </div>
      ...
      <div class="section-bar">
        <div class="btn">
          <button class="btn-base btn-return" @click="$router.push('/shpping')">
            返回购物车
          </button>
...
export default {
  ...
  methods: {
    settlement() {
      // axios.post('/user/order/addOrder',{user_id:this.$store.state.user.user_id,products:this.$store.state.cartList.filter((item) => item.check)}).then(res => {
      //     // console.log(res);
