...
<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="cardNum" label="账号"> </el-table-column>
      <el-table-column prop="name" label="姓名" width="100">
      </el-table-column>
      <el-table-column prop="birthday" label="年龄"> </el-table-column>
      <el-table-column prop="cardNum" label="电话"> </el-table-column>
      <el-table-column prop="integral" label="薪酬" width="80">
      </el-table-column>
      <el-table-column prop="money" label="入职时间" width="80">
      </el-table-column>
