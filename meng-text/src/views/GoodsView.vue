...
<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="name" label="商品编码" width="100">
      </el-table-column>
      <el-table-column prop="birthday" label="商品规格"> </el-table-column>
      <el-table-column prop="cardNum" label="零售价"> </el-table-column>
      <el-table-column prop="integral" label="进货价" width="80">
      </el-table-column>
      <el-table-column prop="money" label="库存数量" width="80">
      </el-table-column>
      <el-table-column prop="payType" label="供应商" width="80">
      </el-table-column>
